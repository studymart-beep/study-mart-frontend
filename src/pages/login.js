  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.card}>
        ...
        <p style={styles.welcomeText}>Log in to continue your learning journey</p>
...
const styles = {
  ...
  backgroundGlow1: {
    ...
    width: '500px',
    height: '500px',
    background: 'radial-gradient(circle, rgba(255,107,53,0.3) 0%, rgba(46,204,113,0.2) 50%, transparent 70%)',
    borderRadius: '50%',
  ...
  backgroundGlow2: {
    ...
    width: '600px',
    height: '600px',
    background: 'radial-gradient(circle, rgba(37,99,235,0.25) 0%, rgba(30,58,138,0.15) 50%, transparent 70%)',
    borderRadius: '50%',
...
const globalStyles = `
  ...
  @keyframes pulse {
    ...
    50% { transform: scale(1.05); filter: drop-shadow(0 12px 24px rgba(255,107,53,0.4)); }
  }
